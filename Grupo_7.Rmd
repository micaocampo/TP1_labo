...
El promedio de la relación es `r promedio_matricula_secciones_valor` estudiantes por cada sección.
...
Con el gráfico de la izquierda ya podemos ver ciertas diferencias y similitudes, pero la agrandamos para ver mejor la variabilidad, en este caso los datos con mayor matrícula no serán tomados en cuenta.
