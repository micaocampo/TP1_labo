...
```{r, echo=FALSE, fig.align='center', fig.width=12, fig.height=4, fig.cap="Distribución de establecimientos por categoría, área y ámbito"}
library(patchwork)
...
```{r, echo=FALSE, fig.width=6, fig.height=3, fig.align='center', fig.cap="Relación entre matrícula y cantidad de secciones"}
...
```{r, echo=FALSE, fig.width=8, fig.align='center', fig.cap="Relación entre matrícula y secciones discriminando por modalidad"}
...
```{r, echo=FALSE, fig.width=6, fig.height=3, fig.align='center', fig.cap="Relación entre matrícula y cantidad de secciones discriminando por área"}
...
```{r, echo=FALSE, fig.width=6, fig.height=3, fig.align='center', fig.cap="Relación entre matrícula y secciones discriminando por sector"}
...
```{r, echo = FALSE, fig.width=4, fig.height=3, fig.align='center', fig.cap="Relación entre matrícula y dependencia"}
ggplot(data = datos_con_categorias, mapping = aes(x = dependencia_grupo, y = matricula)) +
  ...
  labs(
    title = "Relación entre cantidad de estudiantes y dependencia",
    x = "Dependencia",
    y = "Estudiantes") 
...
```{r, echo = FALSE, warning=FALSE, fig.width=4, fig.height=3, fig.align='center', fig.cap="Relación entre matrículas menores a 2000 y dependencia"}
ggplot(data = datos_con_categorias, mapping = aes(x = dependencia_grupo, y = matricula)) +
  geom_violin() +
  ylim(0, 2000) + 
  geom_point(data = promedios, mapping = aes(x = dependencia_grupo, y = promedio_matricula), color = "skyblue", size = 3)  +
...
Ahora hacemos lo mismo para secciones: (cuadro 6)
...
```{r, echo = FALSE, fig.width=4, fig.height=3, fig.align='center', fig.cap="Relación entre secciones y dependencia"}
...
```{r, echo = FALSE, warning=FALSE, fig.width=4, fig.height=3, fig.cap="Relación entre secciones menores a 100 y dependencia"}
ggplot(data = datos_con_categorias, mapping = aes(x = dependencia_grupo, y = secciones)) +
  geom_violin() +
  ylim(0, 100) + 
  geom_point(data = promedios, mapping = aes(x = dependencia_grupo, y = promedio_secciones), color = "skyblue", size = 3)  +
...
la completitud de esta variable es aproximadamente del 89%, es bastante poco y eso hace que nuestro análisis sobre esa variable pierda exactitud, pero igualmente no lo imposiblita ya que, no siempre se espera una completitud total.
